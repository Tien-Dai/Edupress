...
const LogoutIcon = ({ size, ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" height={size} width={size} {...props} viewBox="0 0 24 24">
    <g id="SVGRepo_iconCarrier" fill="currentColor">
      <path
        ...
        clipRule="evenodd"
      ></path>
      <path d="M4 12a8 8 0 0 0 8 8v-3.75c0-.943 0-1.414-.293-1.707s-.764-.293-1.707-.293"></path>
    </g>
  </svg>
);
